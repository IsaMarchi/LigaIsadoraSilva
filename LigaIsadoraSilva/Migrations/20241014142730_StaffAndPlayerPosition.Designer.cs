...
namespace LigaIsadoraSilva.Migrations
{
    ...
    [Migration("20241014142730_StaffAndPlayerPosition")]
    partial class StaffAndPlayerPosition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LigaIsadoraSilva.Data.Entities.FootballMatch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LigaIsadoraSilva.Data.Entities.FootballTeam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LigaIsadoraSilva.Data.Entities.StaffDuty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LigaIsadoraSilva.Data.Entities.FootballMatch", b =>
                {
                    b.HasOne("LigaIsadoraSilva.Data.Entities.FootballTeam", "HomeTeam")
                        .WithMany("HomeGames")
                        .HasForeignKey("HomeTeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LigaIsadoraSilva.Data.Entities.FootballTeam", "VisitTeam")
                        .WithMany("VisitGames")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LigaIsadoraSilva.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
